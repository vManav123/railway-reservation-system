...
import railway.reservation.system.ExceptionHandling.NoTrainExistException;
import railway.reservation.system.ExceptionHandling.TrainNotRunningOnThisDayException;
import railway.reservation.system.Models.*;
import railway.reservation.system.Models.Train.Detail;
...
public class TrainServiceImpl implements TrainService {
    ...
    public List<TrainLocation> trainLocation(String train_search_info,String day,String your_location) {
            ...
            if (isNumeric(train_search_info)) {
                ...
                {
                    return Collections.singletonList(new TrainLocation(e.getMessage(), LocalDateTime.now(), LocalDateTime.now(), "Not Reachable", 12));
                }
            }
            else {
    ...
    public String trainLocationToTable(String train_search_info,String day,String your_location)
    {
        ...
        if(duration.toHoursPart()<0 || duration.toMinutesPart()<0)
            total_Time = " Train already Passed From Your Location ";
        else
            total_Time = "Train will Reach in " + Math.abs(duration.toHoursPart()) + "h " + Math.abs(duration.toMinutesPart()) + "m";
        ...
        for(TrainLocation trainLocation : trainLocationList)
        {
            if(!trainLocation.getCurrent_station().equals(train_location) && !chk.equals("Departed") && !chk.equals("Arriving"))
                chk = "Departed";
            else if(trainLocation.getCurrent_station().equals(train_location) && trainLocation.getDeparture_time().isAfter(LocalDateTime.now())) {
                chk = "Arrived";

                result.append("    ").append(trainLocation.getCurrent_station()).append("                  ").append(trainLocation.getArrival_time()).append("                  ").append(trainLocation.getDeparture_time()).append("                     ").append(chk).append(" ( ").append("Ontime").append(" )").append("                      No Delay                  --->  !!!  Your Train is at this station , ").append(total_Time).append("!!!\n").append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- \n");
                continue;
            }
            else if(trainLocation.getCurrent_station().equals(train_location) && trainLocation.getDeparture_time().isBefore(LocalDateTime.now())) {
                chk = "Arriving";
                result.append("    ").append(trainLocation.getCurrent_station()).append("                  ").append(trainLocation.getArrival_time()).append("                  ").append(trainLocation.getDeparture_time()).append("                     ").append("Departed").append(" ( ").append("Ontime").append(" )").append("                      No Delay                  --->  !!!  Your Train is at this station , ").append(total_Time).append("!!!\n").append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- \n");
                continue;
            }
            else if(trainLocation.getCurrent_station().equals(your_location))
            {
                result.append("    ").append(trainLocation.getCurrent_station()).append("                  ").append(trainLocation.getArrival_time()).append("                  ").append(trainLocation.getDeparture_time()).append("                     ").append(chk).append(" ( ").append("Ontime").append(" )").append("                      No Delay                  --->  !!!  Your are this Station !!!\n").append("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- \n");
                continue;
            }

            result.append("    ").append(trainLocation.getCurrent_station()).append("                   ").append(trainLocation.getArrival_time()).append("                  ").append(trainLocation.getDeparture_time()).append("                      ").append(chk).append(" ( ").append("Ontime").append(" )").append("                       No Delay          \n").append("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- \n");
        }
        return result.toString();
    }
    public List<TrainLocation> getTrainRoute(Train train , String day , String your_location)
    {
        ...
        {
            return Collections.singletonList(new TrainLocation(e.getMessage(), LocalDateTime.MIN, LocalDateTime.MIN, "Not Reachable", 0));
        }
